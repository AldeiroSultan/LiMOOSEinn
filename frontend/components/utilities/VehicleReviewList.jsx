...
function VehicleReviewList({ vehicleId }) {
  ...
  const [loading, error, response] = useFetchData(`/api/v1/get-vehicle-reviews-list/${vehicleId}?limit=${filter.limit}&page=${filter.page}&sort=${filter.sort}`, fetchAgain);
...
VehicleReviewList.defaultProps = {
  vehicleId: ''
};

VehicleReviewList.propTypes = {
