...
import VehicleStatusUpdateModal from '../shared/VehicleStatusUpdateModal';
...
function Orders() {
  ...
  const [statusUpdateModal, setStatusUpdateModal] = useState(
    { open: false, vehicleId: null, status: null }
  );
                            ...
                            data?.booking_status !== 'completed' ? (
                              <Button
                                ...
                                onClick={() => setStatusUpdateModal((prevState) => ({
                                  ...prevState, open: true, vehicleId: data?.id, status: data?.booking_status
                                }))}
                              >
                                Update Status
                              </Button>
