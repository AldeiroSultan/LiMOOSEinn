...
function Main() {
  ...
  useEffect(() => {
    switch (selectedKeys) {
      case '1': {
        window.document.title = 'LiMOOSEin — Dashboard';
        break;
      }
      case '2': {
        window.document.title = 'LiMOOSEin — Users';
        break;
      }
      case '3': {
        window.document.title = 'LiMOOSEin — Rent Vehicles';
        break;
      }
      case '4': {
        window.document.title = 'LiMOOSEin — Booking Orders';
        break;
      }
      case '5': {
        window.document.title = 'LiMOOSEin — Profile';
        break;
      }
      case '6': {
        window.document.title = 'LiMOOSEin — Logout';
        break;
      }
      default: {
        window.document.title = 'LiMOOSEin — Dashboard';
